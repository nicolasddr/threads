...
typedef struct node {
   int dado; //TROCAR
   struct node *proximo; //Ponteiro para o próximo nó da fila
   struct node *inicio; //Ponteiro para o primeiro nó da fila
   struct node *fim; //Ponteiro para o último nó da fila
} node_t;
